...
MsgBuilder.prototype = {
	appInfo: function () {
		return [{
			type: 'info',
			msg: 'Flying Mole v'+pkg.version+', welcome dear mole!'
		}, {
			type: 'features',
			hardware: this.quad.features,
			updaters: this.quad.ctrl.constructor.available
		}];
	},
	enabled: function () {
		return {
	...
	motorsForces: function () {
		return {
			type: 'motors-forces',
			forces: this.quad.motorsForces || [0, 0, 0, 0]
		};
	},
	error: function (msg) {
		return {
