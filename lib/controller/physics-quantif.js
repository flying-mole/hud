...
class PhysicsUpdater extends BaseUpdater {
	...
	update(data) {
		...
		E = l * this.lastDF * this.lastSign * force / (9.81 * boxM * boxH);
		alpha = this.lastTheta0 - E;
		beta = (this.lastOmega0 - c * alpha / 2 / Q) / omega;
		...
		this.lastDF = deltaF;
		this.lastTheta0 = theta0;
		this.lastOmega0 = omega0;
		this.lastSign = sign;
